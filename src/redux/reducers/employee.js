import { addManyByName, convertToStorage } from "../../utils/db/dbUtilMethods";
...
const employeeReducer = (state = useState, action) => {
    switch (action.type) {
      ...
      case "UPDATE":
        ...
        //Set the new state in DB
        employeeList = addManyByName(newState)
        console.log('ReduxReducer-employeeJS.UPDATE.employeeList: ', employeeList)
        //Add the of Id's to SessionStorage
        convertToStorage(newState)
